...
urlpatterns = [
    ...
    path('about', views.AboutUsView.as_view(template_name='frontend_new/about.html'), name='about'),
    path('book-list', views.BookListPageView.as_view(template_name='frontend_new/book_list.html'), name='book-list'),
